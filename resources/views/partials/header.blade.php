<header
    class="border-b border-border/60 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 sticky top-0 z-30">
    <div class="container-custom flex items-center justify-between py-4 gap-6">
        ...
        <nav class="hidden lg:flex items-center gap-6 text-sm font-medium text-[#1A1A1A]">
            ...
            <a href="{{ route('pages.online-prep') }}"
                class="hover:text-[#1055b2] transition-colors">Онлайн‑подготовка</a>
        </nav>
